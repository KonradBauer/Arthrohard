          ...
          <LeftSide>
            ...
            <Description>
              ...
              <Details>
                ...
                pomaga zwalczać enzymy, które niszczą chrząstkę, a także pomaga chrząstce zatrzymać
                wodę, co jest ważne dla jej sprężystości i absorpcji wstrząsów.
              </Details>
            </Description>
            <StyledEllipse />
            <Description>
              ...
              <Text>50 mg</Text>
              <Details>
                Kwas hialuronowy jest kluczowym składnikiem płynu stawowego, który działa jak smar i
                amortyzator dla stawów. Suplementacja kwasem hialuronowym może pomóc w utrzymaniu
                prawidłowej objętości i konsystencji płynu stawowego.
              </Details>
            </Description>
          </LeftSide>
        </ContentBox>
        ...
        <ContentBox>
          <RightSide>
            ...
            <Description>
              ...
              <Text>250 mg</Text>
              <Details>
                Czarci pazur jest rośliną, która ma właściwości przeciwzapalne i przeciwbólowe. Może
                to pomóc zwierzętom, które doświadczają bólu i stanu zapalnego związanego z
            ...
            <Description>
              ...
              <Details>
                ...
                witamina C odgrywa ważną rolę w produkcji kolagenu, kluczowego składnika chrząstki.
              </Details>
            </Description>
            <StyledEllipse />
            <Description>
